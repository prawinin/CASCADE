...
def _find_ligand_atoms(structure: Structure.Structure, ligand_resname: str, ligand_chain: str = None, ligand_seq: int = None) -> Tuple[List[Atom.Atom], Optional[Residue.Residue]]:
...
def extract_pocket_residues(
    ...
    """
    ligand_atoms, ligand_residue = _find_ligand_atoms(structure, ligand_resname, ligand_chain, ligand_seq)
